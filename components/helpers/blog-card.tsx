...
export default function BlogCard({ blog }: Props) {
  return (
    <Link
      href={`/blogs/${blog.id}`}
      className="group block bg-theme-bg-200 rounded-2xl border border-theme-bg-300 shadow-theme-lg hover:shadow-theme-xl transition-all duration-200 overflow-hidden"
    >
